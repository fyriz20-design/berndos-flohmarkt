...
import ProductList from './ProductList'; // Das holt dein altes Design zurück!
...
export default async function HomePage() {
  ...
  try {
    ...
    if (prismaAny) {
      // Wir holen die Daten (egal ob sie 'article' oder 'product' heißen)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-sm p-4 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="/admin" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">Admin</a>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto py-10 px-4">
        {/* WICHTIG: Hier nutzen wir jetzt die ProductList Komponente */}
        {products.length > 0 ? (
